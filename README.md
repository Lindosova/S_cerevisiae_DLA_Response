...
Обзор изменений экспрессии генов. Ответ на 5 mM DLA (125 и 113 дифференциально экспрессированных генов (ДЭГ)), обозначенными красными точками (каждая точка соответствует одному гену).
